...
def go():
    ...
    with codecs.open(E3.get(), 'w', encoding='utf8') as fOut:
...
def select_output_file():
    ...
    E3.delete(0,END)
    E3.insert(0,inputfile)
    E3.xview_moveto(1)

top = Tk()
top.title("MTUOC bitext mining")

B1=tkinter.Button(top, text = str("File L1"), borderwidth = 1, command=select_file_L1,width=14).grid(row=0,column=0)
E1 = tkinter.Entry(top, bd = 5, width=50, justify="right")
E1.grid(row=0,column=1)

B2=tkinter.Button(top, text = str("File L2"), borderwidth = 1, command=select_file_L2,width=14).grid(row=1,column=0)
E2 = tkinter.Entry(top, bd = 5, width=50, justify="right")
E2.grid(row=1,column=1)

B3=tkinter.Button(top, text = str("Output file"), borderwidth = 1, command=select_output_file,width=14).grid(row=2,column=0)
E3 = tkinter.Entry(top, bd = 5, width=50, justify="right")
E3.grid(row=2,column=1)

B4=tkinter.Button(top, text = str("Go"), borderwidth = 1, command=go,width=14).grid(row=3,column=0)
